...
public class custB {
	...
	{
		//System.out.println("Customer B has joint A/c no: "+accn.acc_No);
		//System.out.println("Customer B has "+accn);
		System.out.println("Customer B has joint A/c no: "+acc.acc_No);
		System.out.println("Customer B has "+acc);
	}
}
