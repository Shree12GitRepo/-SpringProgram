...
public class ShoopingTest {
	...
	public static void main(String[] args) {
		...
		//FlipkartShoppingApp fkrt=factory.getBean("fkrtshpng",FlipkartShoppingApp.class);
		FlipkartShoppingApp fkrt=factory.getBean("dtdcshpng",FlipkartShoppingApp.class);
