...
public class SBIDetailsVO {
	...
	public String toString() {
		return "SBIDetailsVO [id=" + id + ", branch_name=" + branch_name + ", bank_Mgr_Name=" + bank_Mgr_Name
				+ ", branch_Mgr_Name=" + branch_Mgr_Name + ", accountant_Name=" + accountant_Name
				+ ", security_Guard_Name=" + security_Guard_Name + ", ifsc_code=" + ifsc_code + ", doj=" + doj + "]";
	}
